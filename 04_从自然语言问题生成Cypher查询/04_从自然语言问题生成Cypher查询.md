...
Persons（人物）：当用户按职业询问某个人时，指的是带有 Person 标签的节点。Movies（电影）：当用户询问某部影片时，指的是带有 Movie 标签的节点。
...
人物：当用户询问演员、编剧、导演、制片人或影评人等职业相关的人物时，所指的是标签为 Person 的节点。电影：当用户询问影片或电影相关内容时，所指的是标签为 Movie 的节点。
